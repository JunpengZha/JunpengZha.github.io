...
(** * Thread Event *)
(** The ThreadEvent corresponds to (ThrdEvt) in Figure 5 in paper. *)
...
Module Local.
  ...
  (** ** Program step *)
  (** Program step to execute instructions in program:
      - [step_silent]: executing instructions that only modify the thread-local state;
      - [step_read]: memory read;
      - [step_write]: memory write;
      - [step_update]: atomic update;
      - [step_fence]: fence operations;
      - [step_syscall]: system call, generating observable event *)
