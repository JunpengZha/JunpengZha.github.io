...
Module MemoryReorder.
  ...
  Proof.
    ...
    des.
    assert(exists mem1', Memory.add mem0 loc2 from2 to2 msg2 mem1').
    {
  ...
  Proof.
    ...
    {
      assert(exists mem1', Memory.add mem0 loc from2 to2 msg2 mem1').
      {
        eapply Memory.add_exists; eauto.
        i. 
  ...
  Lemma split_remove_the_split_msg_stable
    ...
    exists from0', Memory.get loc0 to0 mem3 = Some (from0', msg0).
  Proof.
